...
The system prompt contains 10 few-shot examples covering Spanish, French, Japanese, German, Korean, Mandarin Chinese, Portuguese, Arabic, English (with Spanish native speaker), and Russian to match the details given about the task's test suite in the FAQ.
